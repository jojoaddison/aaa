...
class AlbumGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Album entity")
        ...
        .repeat(2) {
            ...
            .post("/api/albums")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "photos":"SAMPLE_TEXT", "isDefault":null, "created":"2020-01-01T00:00:00.000Z", "modified":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
