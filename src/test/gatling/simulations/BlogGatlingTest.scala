...
class BlogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Blog entity")
        ...
        .repeat(2) {
            ...
            .post("/api/blogs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
