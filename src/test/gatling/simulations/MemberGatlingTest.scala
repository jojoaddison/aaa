...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .post("/api/members")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "middleNames":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "mobilePhone":"SAMPLE_TEXT", "telephoneNumber":"SAMPLE_TEXT", "display":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "donations":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
